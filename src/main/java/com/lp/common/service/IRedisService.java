...
public interface IRedisService {
     ...
     * 设置值 超时时间为默认时间(根据配置文件,如果没有设置则为一直有效)
     * @param key
     * @param value
     */
     ...
     * @param value
     */
    public abstract void setForever(final String key, final String value);
    ...
    public abstract void hSet(final String key, final String field, final byte[] value);
