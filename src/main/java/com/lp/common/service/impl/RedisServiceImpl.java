...
import com.lp.framework.utils.SerializeUtil;
...
/**
 * Created by CPR161 on 2016-11-30.
 */
...
public class RedisServiceImpl implements IRedisService{
    ...
    public  void setForever(final String key, final String value) {
        redisTemplate.execute(new RedisCallback<Serializable>() {
    ...
    public Set<String> sMembers(final String key){
        ...
        return redisTemplate.execute(new RedisCallback<Set<String>>() {
            ...
            public Set<String> doInRedis(RedisConnection connection)
                ...
                Set<byte[]> set = connection.sMembers(redisTemplate
                        .getStringSerializer().serialize(key));
    ...
    public void sRem(final String key,final String value){
        redisTemplate.execute(new RedisCallback<Serializable>() {
            public Serializable doInRedis(RedisConnection redisConnection) throws DataAccessException {
                redisConnection.sRem(redisTemplate.getStringSerializer().serialize(key),redisTemplate.getStringSerializer().serialize(value));
                return true;
            }
        });
    }
    ...
    public long lLen(final String key) {
        return redisTemplate.execute(new RedisCallback<Long>() {
            public Long doInRedis(RedisConnection connection)
                    throws DataAccessException {
                return connection.lLen(redisTemplate.getStringSerializer()
                        .serialize(key));
            }
        });
    }
    ...
    public void rPush(final String key,final String value) {
        redisTemplate.execute(new RedisCallback<Serializable>() {
            public Serializable doInRedis(RedisConnection redisConnection) throws DataAccessException {
                redisConnection.rPush(redisTemplate.getStringSerializer().serialize(key),redisTemplate.getStringSerializer().serialize(value));
                return true;
            }
        });
    }
    ...
    public void lPop(final String key) {
        redisTemplate.execute(new RedisCallback<Serializable>() {
            public Serializable doInRedis(RedisConnection redisConnection) throws DataAccessException {
                redisConnection.lPop(redisTemplate.getStringSerializer().serialize(key));
                return true;
            }
        });
    }
